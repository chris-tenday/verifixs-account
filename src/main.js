...
Vue.component('privacyModal', require('@/components/utilities/privacy_modal').default);
Vue.component('actifModal', require('@/components/widgets/modals/actif_detail_modal').default);
Vue.component('detailModal', require('@/components/widgets/modals/actif_selected_details_modal.vue').default);
...
Vue.component('customDateInput', require('@/components/widgets/custom_date_input').default);
