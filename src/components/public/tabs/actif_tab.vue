<template>
  <div data-aos="fade-up">
    <go_to_tab
      ...
      @gototab="goToTab"
      :askpermission="askCheckingPermission"
      permission-text="Est-ce que vous nous autoriser à cette information?"
    ></go_to_tab>
    ...
    <div class="row" v-if="diligenceActifs.length">
      <div class="col-lg-12 col-md-12 col-12 mb-3">
        <div class="d-flex justify-content-between">
          ...
          <button
            @click="toggleScrollerBottom"
            class="btn bg-dual-gradient text-white rounded border-0"
          >
            <span v-if="!newActif" class="fs-7"
              ><i class="fas fa-plus me-1"></i>Ajouter plus d'actifs</span
            >
      ...
      <div
        class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12"
        v-for="(actif, index) in diligenceActifs"
        :key="index"
      >
        <div class="card mb-6 text-center border-0 bg-light-success">
          <div class="card-body p-5">
            <div class="mb-3">
              <img
                src="assets/images/svg/mortgage.svg"
    ...
    <div class="row" data-aos="fade-up" id="target" v-if="newActif">
      ...
      <div
        class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12"
        v-for="(actif, index) in actifs"
        :key="index"
      >
        <div class="card text-center text-white bg-dual-gradient mb-6">
          <div
            class="icon-shape icon-lg bg-primary-gradient rounded-circle mx-auto mt-n4 text-white"
          >
          ...
          <div class="card-body p-6">
            ...
            <button
              class="btn btn-sm btn-light mt-2 border-0"
              @click="$emit('showDetails', actif)"
            >
